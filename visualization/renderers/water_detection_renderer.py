...
class WaterDetectionRenderer:
    """
    Renderer for water detection indices (NDWI, MNDWI, AWEIsh, AWEInsh).
    Colors range from White/Light Blue to Dark Blue.
    """
    
    @staticmethod
    def _create_ramp() -> 'QgsGradientColorRamp':
        colors = ["#FFFFFF", "#D9F2FF", "#8FD3FF", "#3399FF", "#005CE6", "#001F99"]
    ...
    def create(provider, min_val: float, max_val: float) -> 'QgsSingleBandPseudoColorRenderer':
        ...
        ramp = WaterDetectionRenderer._create_ramp()
